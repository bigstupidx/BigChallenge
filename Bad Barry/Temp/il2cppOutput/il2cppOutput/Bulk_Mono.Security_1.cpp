...
extern "C" void TlsServerCertificate__ctor_m4757 (TlsServerCertificate_t914 * __this, Context_t859 * ___context, ByteU5BU5D_t772* ___buffer, const MethodInfo* method)
{
	{
		Context_t859 * L_0 = ___context;
		ByteU5BU5D_t772* L_1 = ___buffer;
		HandshakeMessage__ctor_m4722(__this, L_0, ((int32_t)11), L_1, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerCertificate::Update()
extern "C" void TlsServerCertificate_Update_m4758 (TlsServerCertificate_t914 * __this, const MethodInfo* method)
{
	{
		HandshakeMessage_Update_m4727(__this, /*hidden argument*/NULL);
		Context_t859 * L_0 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_0);
		TlsServerSettings_t870 * L_1 = Context_get_ServerSettings_m4425(L_0, /*hidden argument*/NULL);
		X509CertificateCollection_t827 * L_2 = (__this->___certificates_9);
		NullCheck(L_1);
		TlsServerSettings_set_Certificates_m4684(L_1, L_2, /*hidden argument*/NULL);
		Context_t859 * L_3 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_3);
		TlsServerSettings_t870 * L_4 = Context_get_ServerSettings_m4425(L_3, /*hidden argument*/NULL);
		NullCheck(L_4);
		TlsServerSettings_UpdateCertificateRSA_m4693(L_4, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerCertificate::ProcessAsSsl3()
extern "C" void TlsServerCertificate_ProcessAsSsl3_m4759 (TlsServerCertificate_t914 * __this, const MethodInfo* method)
{
	{
...
extern "C" void TlsServerCertificate_ProcessAsTls1_m4760 (TlsServerCertificate_t914 * __this, const MethodInfo* method)
{
	...
	X509Certificate_t829 * V_4 = {0};
	{
		...
		X509CertificateCollection__ctor_m4199(L_0, /*hidden argument*/NULL);
		__this->___certificates_9 = L_0;
		V_0 = 0;
		int32_t L_1 = TlsStream_ReadInt24_m4706(__this, /*hidden argument*/NULL);
		V_1 = L_1;
		goto IL_004d;
	}
...
IL_0019:
	{
		int32_t L_2 = TlsStream_ReadInt24_m4706(__this, /*hidden argument*/NULL);
		V_2 = L_2;
		int32_t L_3 = V_0;
	...
	{
		int32_t L_5 = V_2;
		ByteU5BU5D_t772* L_6 = TlsStream_ReadBytes_m4707(__this, L_5, /*hidden argument*/NULL);
		V_3 = L_6;
		...
		X509Certificate__ctor_m4159(L_8, L_7, /*hidden argument*/NULL);
		V_4 = L_8;
		X509CertificateCollection_t827 * L_9 = (__this->___certificates_9);
		X509Certificate_t829 * L_10 = V_4;
		NullCheck(L_9);
		X509CertificateCollection_Add_m4203(L_9, L_10, /*hidden argument*/NULL);
		int32_t L_11 = V_0;
		int32_t L_12 = V_2;
...
IL_004d:
	...
	}
	{
		...
		TlsServerCertificate_validateCertificates_m4762(__this, L_15, /*hidden argument*/NULL);
		return;
	}
}
...
extern "C" bool TlsServerCertificate_checkCertificateUsage_m4761 (TlsServerCertificate_t914 * __this, X509Certificate_t829 * ___cert, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	int32_t G_B26_0 = 0;
	{
		...
		NullCheck(L_1);
		int32_t L_2 = X509Certificate_get_Version_m4181(L_1, /*hidden argument*/NULL);
...
IL_001a:
	{
		...
		NullCheck(L_3);
		SecurityParameters_t872 * L_4 = Context_get_Negotiating_m4469(L_3, /*hidden argument*/NULL);
		NullCheck(L_4);
		CipherSuite_t858 * L_5 = SecurityParameters_get_Cipher_m4539(L_4, /*hidden argument*/NULL);
		NullCheck(L_5);
		int32_t L_6 = CipherSuite_get_ExchangeAlgorithmType_m4332(L_5, /*hidden argument*/NULL);
		V_6 = L_6;
		int32_t L_7 = V_6;
		if (L_7 == 0)
		{
...
IL_006a:
	{
		...
		NullCheck(L_8);
		X509ExtensionCollection_t831 * L_9 = X509Certificate_get_Extensions_m4165(L_8, /*hidden argument*/NULL);
		NullCheck(L_9);
		X509Extension_t838 * L_10 = X509ExtensionCollection_get_Item_m4253(L_9, _stringLiteral692, /*hidden argument*/NULL);
		V_4 = L_10;
	...
	}
	{
		...
		KeyUsageExtension__ctor_m4287(L_13, L_12, /*hidden argument*/NULL);
		V_2 = L_13;
	}
...
IL_008f:
	{
		...
		NullCheck(L_14);
		X509ExtensionCollection_t831 * L_15 = X509Certificate_get_Extensions_m4165(L_14, /*hidden argument*/NULL);
		NullCheck(L_15);
		X509Extension_t838 * L_16 = X509ExtensionCollection_get_Item_m4253(L_15, _stringLiteral693, /*hidden argument*/NULL);
		V_4 = L_16;
	...
	}
	{
		...
		ExtendedKeyUsageExtension__ctor_m4278(L_19, L_18, /*hidden argument*/NULL);
		V_3 = L_19;
	}
...
IL_00b0:
	...
	}
	{
		...
		int32_t L_23 = V_1;
		NullCheck(L_22);
		bool L_24 = KeyUsageExtension_Support_m4290(L_22, L_23, /*hidden argument*/NULL);
		if (L_24)
		{
			goto IL_00ca;
		}
...
IL_00ca:
	{
		...
		NullCheck(L_25);
		ArrayList_t803 * L_26 = ExtendedKeyUsageExtension_get_KeyPurpose_m4281(L_25, /*hidden argument*/NULL);
		NullCheck(L_26);
		bool L_27 = (bool)VirtFuncInvoker1< bool, Object_t * >::Invoke(32 /* System.Boolean System.Collections.ArrayList::Contains(System.Object) */, L_26, _stringLiteral569);
		if (L_27)
		{
			goto IL_00f1;
		}
	}
	{
		...
		NullCheck(L_28);
		ArrayList_t803 * L_29 = ExtendedKeyUsageExtension_get_KeyPurpose_m4281(L_28, /*hidden argument*/NULL);
		NullCheck(L_29);
		bool L_30 = (bool)VirtFuncInvoker1< bool, Object_t * >::Invoke(32 /* System.Boolean System.Collections.ArrayList::Contains(System.Object) */, L_29, _stringLiteral694);
...
IL_00f3:
	...
	}
	{
		...
		int32_t L_33 = V_1;
		NullCheck(L_32);
		bool L_34 = KeyUsageExtension_Support_m4290(L_32, L_33, /*hidden argument*/NULL);
		return L_34;
	}
...
IL_0101:
	...
	}
	{
		...
		NullCheck(L_36);
		ArrayList_t803 * L_37 = ExtendedKeyUsageExtension_get_KeyPurpose_m4281(L_36, /*hidden argument*/NULL);
		NullCheck(L_37);
		bool L_38 = (bool)VirtFuncInvoker1< bool, Object_t * >::Invoke(32 /* System.Boolean System.Collections.ArrayList::Contains(System.Object) */, L_37, _stringLiteral569);
		if (L_38)
		{
			goto IL_012e;
		}
	}
	{
		...
		NullCheck(L_39);
		ArrayList_t803 * L_40 = ExtendedKeyUsageExtension_get_KeyPurpose_m4281(L_39, /*hidden argument*/NULL);
		NullCheck(L_40);
		bool L_41 = (bool)VirtFuncInvoker1< bool, Object_t * >::Invoke(32 /* System.Boolean System.Collections.ArrayList::Contains(System.Object) */, L_40, _stringLiteral694);
...
IL_0130:
	{
		...
		NullCheck(L_42);
		X509ExtensionCollection_t831 * L_43 = X509Certificate_get_Extensions_m4165(L_42, /*hidden argument*/NULL);
		NullCheck(L_43);
		X509Extension_t838 * L_44 = X509ExtensionCollection_get_Item_m4253(L_43, _stringLiteral695, /*hidden argument*/NULL);
		V_4 = L_44;
	...
	}
	{
		...
		NetscapeCertTypeExtension__ctor_m4292(L_47, L_46, /*hidden argument*/NULL);
		V_5 = L_47;
		NetscapeCertTypeExtension_t849 * L_48 = V_5;
		NullCheck(L_48);
		bool L_49 = NetscapeCertTypeExtension_Support_m4294(L_48, ((int32_t)64), /*hidden argument*/NULL);
		return L_49;
	}
...
extern "C" void TlsServerCertificate_validateCertificates_m4762 (TlsServerCertificate_t914 * __this, X509CertificateCollection_t827 * ___certificates, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	NO_UNUSED_WARNING (__leave_target);
	{
		...
		NullCheck(L_1);
		SslClientStream_t863 * L_2 = ClientContext_get_SslStream_m4385(L_1, /*hidden argument*/NULL);
		NullCheck(L_2);
	...
	}
	{
		...
		NullCheck(L_4);
		SslClientStream_t863 * L_5 = ClientContext_get_SslStream_m4385(L_4, /*hidden argument*/NULL);
		...
		NullCheck(L_8);
		bool L_9 = ValidationResult_get_Trusted_m4546(L_8, /*hidden argument*/NULL);
		if (!L_9)
		{
			goto IL_0038;
		}
...
IL_0038:
	{
		...
		NullCheck(L_10);
		int32_t L_11 = ValidationResult_get_ErrorCode_m4547(L_10, /*hidden argument*/NULL);
...
IL_008f:
	{
		...
		String_t* L_19 = String_Format_m659(NULL /*static, unused*/, _stringLiteral696, L_18, /*hidden argument*/NULL);
		V_4 = L_19;
		uint8_t L_20 = V_1;
		String_t* L_21 = V_4;
		String_t* L_22 = String_Concat_m530(NULL /*static, unused*/, _stringLiteral697, L_21, /*hidden argument*/NULL);
		TlsException_t904 * L_23 = (TlsException_t904 *)il2cpp_codegen_object_new (TlsException_t904_il2cpp_TypeInfo_var);
		TlsException__ctor_m4678(L_23, L_20, L_22, /*hidden argument*/NULL);
...
IL_00b4:
	{
		...
		NullCheck(L_24);
		X509Certificate_t829 * L_25 = X509CertificateCollection_get_Item_m4202(L_24, 0, /*hidden argument*/NULL);
		V_5 = L_25;
		...
		X509Certificate__ctor_m4921(L_28, L_27, /*hidden argument*/NULL);
		V_6 = L_28;
		ArrayList_t803 * L_29 = (ArrayList_t803 *)il2cpp_codegen_object_new (ArrayList_t803_il2cpp_TypeInfo_var);
		ArrayList__ctor_m4812(L_29, /*hidden argument*/NULL);
		V_7 = L_29;
		X509Certificate_t829 * L_30 = V_5;
		bool L_31 = TlsServerCertificate_checkCertificateUsage_m4761(__this, L_30, /*hidden argument*/NULL);
		if (L_31)
		{
			goto IL_00f1;
		}
...
IL_00f1:
	{
		...
		bool L_36 = TlsServerCertificate_checkServerIdentity_m4763(__this, L_35, /*hidden argument*/NULL);
		if (L_36)
		{
			goto IL_0110;
		}
...
IL_0110:
	{
		...
		X509CertificateCollection__ctor_m4200(L_41, L_40, /*hidden argument*/NULL);
		V_8 = L_41;
		X509CertificateCollection_t827 * L_42 = V_8;
		X509Certificate_t829 * L_43 = V_5;
		NullCheck(L_42);
		X509CertificateCollection_Remove_m4209(L_42, L_43, /*hidden argument*/NULL);
		...
		X509Chain__ctor_m4212(L_45, L_44, /*hidden argument*/NULL);
		V_9 = L_45;
		V_10 = 0;
	}
...
IL_012d:
	...
	{ // begin try (depth: 1)
		...
		NullCheck(L_46);
		bool L_48 = X509Chain_Build_m4215(L_46, L_47, /*hidden argument*/NULL);
		V_10 = L_48;
		goto IL_0146;
	} // end try (depth: 1)
...
IL_0146:
	...
	}
	{
		...
		NullCheck(L_50);
		int32_t L_51 = X509Chain_get_Status_m4213(L_50, /*hidden argument*/NULL);
		V_13 = L_51;
		int32_t L_52 = V_13;
...
IL_0227:
	{
		...
		NullCheck(L_77);
		int32_t L_78 = X509Chain_get_Status_m4213(L_77, /*hidden argument*/NULL);
		int32_t L_79 = L_78;
...
IL_0243:
	{
		...
		NullCheck(L_84);
		SslClientStream_t863 * L_85 = ClientContext_get_SslStream_m4385(L_84, /*hidden argument*/NULL);
	...
	}
	{
		...
		TlsException__ctor_m4678(L_90, L_89, _stringLiteral698, /*hidden argument*/NULL);
...
extern "C" bool TlsServerCertificate_checkServerIdentity_m4763 (TlsServerCertificate_t914 * __this, X509Certificate_t829 * ___cert, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	int32_t V_9 = 0;
	{
		...
		ClientContext_t862 * L_1 = V_0;
		NullCheck(L_1);
		TlsClientSettings_t871 * L_2 = Context_get_ClientSettings_m4426(L_1, /*hidden argument*/NULL);
		NullCheck(L_2);
		String_t* L_3 = TlsClientSettings_get_TargetHost_m4666(L_2, /*hidden argument*/NULL);
		V_1 = L_3;
		X509Certificate_t829 * L_4 = ___cert;
		NullCheck(L_4);
		X509ExtensionCollection_t831 * L_5 = X509Certificate_get_Extensions_m4165(L_4, /*hidden argument*/NULL);
		NullCheck(L_5);
		X509Extension_t838 * L_6 = X509ExtensionCollection_get_Item_m4253(L_5, _stringLiteral699, /*hidden argument*/NULL);
		V_2 = L_6;
	...
	}
	{
		...
		SubjectAltNameExtension__ctor_m4296(L_9, L_8, /*hidden argument*/NULL);
		V_3 = L_9;
		SubjectAltNameExtension_t850 * L_10 = V_3;
		NullCheck(L_10);
		StringU5BU5D_t85* L_11 = SubjectAltNameExtension_get_DNSNames_m4298(L_10, /*hidden argument*/NULL);
		V_5 = L_11;
		V_6 = 0;
		goto IL_0062;
	}
...
IL_0046:
	{
		...
		String_t* L_15 = V_1;
		String_t* L_16 = V_4;
		bool L_17 = TlsServerCertificate_Match_m4765(NULL /*static, unused*/, L_15, L_16, /*hidden argument*/NULL);
		if (!L_17)
		{
			goto IL_005c;
		}
...
IL_0062:
	...
	}
	{
		...
		NullCheck(L_21);
		StringU5BU5D_t85* L_22 = SubjectAltNameExtension_get_IPAddresses_m4299(L_21, /*hidden argument*/NULL);
		V_8 = L_22;
		V_9 = 0;
		goto IL_0099;
	}
...
IL_00a4:
	{
		...
		bool L_34 = TlsServerCertificate_checkDomainName_m4764(__this, L_33, /*hidden argument*/NULL);
		return L_34;
	}
}
...
extern "C" bool TlsServerCertificate_checkDomainName_m4764 (TlsServerCertificate_t914 * __this, String_t* ___subjectName, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	MatchCollection_t971 * V_3 = {0};
	{
		...
		Regex__ctor_m4930(L_2, _stringLiteral700, /*hidden argument*/NULL);
		V_2 = L_2;
		Regex_t678 * L_3 = V_2;
		String_t* L_4 = ___subjectName;
		NullCheck(L_3);
		MatchCollection_t971 * L_5 = Regex_Matches_m4931(L_3, L_4, /*hidden argument*/NULL);
		V_3 = L_5;
	...
	}
	{
		...
		NullCheck(L_9);
		bool L_10 = Group_get_Success_m4932(L_9, /*hidden argument*/NULL);
		if (!L_10)
		{
			goto IL_005f;
		}
	}
	{
		...
		NullCheck(L_13);
		Group_t974 * L_14 = GroupCollection_get_Item_m4933(L_13, 1, /*hidden argument*/NULL);
		NullCheck(L_14);
		String_t* L_15 = Capture_get_Value_m4934(L_14, /*hidden argument*/NULL);
		NullCheck(L_15);
		String_t* L_16 = String_ToString_m3586(L_15, /*hidden argument*/NULL);
		V_1 = L_16;
	}
...
IL_005f:
	{
		...
		NullCheck(L_17);
		TlsClientSettings_t871 * L_18 = Context_get_ClientSettings_m4426(L_17, /*hidden argument*/NULL);
		NullCheck(L_18);
		String_t* L_19 = TlsClientSettings_get_TargetHost_m4666(L_18, /*hidden argument*/NULL);
		String_t* L_20 = V_1;
		bool L_21 = TlsServerCertificate_Match_m4765(NULL /*static, unused*/, L_19, L_20, /*hidden argument*/NULL);
		return L_21;
	}
}
...
extern TypeInfo* String_t_il2cpp_TypeInfo_var;
extern "C" bool TlsServerCertificate_Match_m4765 (Object_t * __this /* static, unused */, String_t* ___hostname, String_t* ___pattern, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	int32_t G_B15_0 = 0;
	{
		...
		NullCheck(L_0);
		int32_t L_1 = String_IndexOf_m2445(L_0, ((int32_t)42), /*hidden argument*/NULL);
		V_0 = L_1;
		int32_t L_2 = V_0;
	...
	}
	{
		...
		CultureInfo_t670 * L_5 = CultureInfo_get_InvariantCulture_m4821(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
		int32_t L_6 = String_Compare_m4935(NULL /*static, unused*/, L_3, L_4, 1, L_5, /*hidden argument*/NULL);
...
IL_0021:
	{
		...
		NullCheck(L_8);
		int32_t L_9 = String_get_Length_m2377(L_8, /*hidden argument*/NULL);
	...
	}
	{
		...
		int32_t L_11 = V_0;
		NullCheck(L_10);
		uint16_t L_12 = String_get_Chars_m2395(L_10, ((int32_t)((int32_t)L_11+(int32_t)1)), /*hidden argument*/NULL);
...
IL_0041:
	{
		...
		int32_t L_14 = V_0;
		NullCheck(L_13);
		int32_t L_15 = String_IndexOf_m4936(L_13, ((int32_t)42), ((int32_t)((int32_t)L_14+(int32_t)1)), /*hidden argument*/NULL);
		V_1 = L_15;
		int32_t L_16 = V_1;
...
IL_0056:
	{
		...
		int32_t L_18 = V_0;
		NullCheck(L_17);
		String_t* L_19 = String_Substring_m2422(L_17, ((int32_t)((int32_t)L_18+(int32_t)1)), /*hidden argument*/NULL);
		V_2 = L_19;
...
IL_0077:
	{
		...
		String_t* L_28 = V_2;
		NullCheck(L_28);
		int32_t L_29 = String_get_Length_m2377(L_28, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(CultureInfo_t670_il2cpp_TypeInfo_var);
		CultureInfo_t670 * L_30 = CultureInfo_get_InvariantCulture_m4821(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
		int32_t L_31 = String_Compare_m4937(NULL /*static, unused*/, L_25, L_26, L_27, 0, L_29, 1, L_30, /*hidden argument*/NULL);
		if (!L_31)
		{
			goto IL_0093;
		}
...
IL_0093:
	...
	}
	{
		...
		NullCheck(L_33);
		int32_t L_34 = String_IndexOf_m2445(L_33, ((int32_t)46), /*hidden argument*/NULL);
		V_4 = L_34;
		int32_t L_35 = V_4;
	...
	}
	{
		...
		NullCheck(L_37);
		int32_t L_38 = String_get_Length_m2377(L_37, /*hidden argument*/NULL);
		String_t* L_39 = V_2;
		NullCheck(L_39);
		int32_t L_40 = String_get_Length_m2377(L_39, /*hidden argument*/NULL);
...
IL_00c3:
	{
		...
		int32_t L_42 = V_0;
		NullCheck(L_41);
		String_t* L_43 = String_Substring_m2396(L_41, 0, L_42, /*hidden argument*/NULL);
		V_5 = L_43;
		String_t* L_44 = ___hostname;
		String_t* L_45 = V_5;
		String_t* L_46 = V_5;
		NullCheck(L_46);
		int32_t L_47 = String_get_Length_m2377(L_46, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(CultureInfo_t670_il2cpp_TypeInfo_var);
		CultureInfo_t670 * L_48 = CultureInfo_get_InvariantCulture_m4821(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
		int32_t L_49 = String_Compare_m4937(NULL /*static, unused*/, L_44, 0, L_45, 0, L_47, 1, L_48, /*hidden argument*/NULL);
		return ((((int32_t)L_49) == ((int32_t)0))? 1 : 0);
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerCertificateRequest::.ctor(Mono.Security.Protocol.Tls.Context,System.Byte[])
extern "C" void TlsServerCertificateRequest__ctor_m4766 (TlsServerCertificateRequest_t915 * __this, Context_t859 * ___context, ByteU5BU5D_t772* ___buffer, const MethodInfo* method)
{
	{
		Context_t859 * L_0 = ___context;
		ByteU5BU5D_t772* L_1 = ___buffer;
		HandshakeMessage__ctor_m4722(__this, L_0, ((int32_t)13), L_1, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerCertificateRequest::Update()
extern "C" void TlsServerCertificateRequest_Update_m4767 (TlsServerCertificateRequest_t915 * __this, const MethodInfo* method)
{
	{
		HandshakeMessage_Update_m4727(__this, /*hidden argument*/NULL);
		Context_t859 * L_0 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		...
		NullCheck(L_1);
		TlsServerSettings_set_CertificateTypes_m4691(L_1, L_2, /*hidden argument*/NULL);
		Context_t859 * L_3 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_3);
		TlsServerSettings_t870 * L_4 = Context_get_ServerSettings_m4425(L_3, /*hidden argument*/NULL);
		StringU5BU5D_t85* L_5 = (__this->___distinguisedNames_10);
		NullCheck(L_4);
		TlsServerSettings_set_DistinguisedNames_m4692(L_4, L_5, /*hidden argument*/NULL);
		Context_t859 * L_6 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_6);
		TlsServerSettings_t870 * L_7 = Context_get_ServerSettings_m4425(L_6, /*hidden argument*/NULL);
		NullCheck(L_7);
		TlsServerSettings_set_CertificateRequest_m4690(L_7, 1, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerCertificateRequest::ProcessAsSsl3()
extern "C" void TlsServerCertificateRequest_ProcessAsSsl3_m4768 (TlsServerCertificateRequest_t915 * __this, const MethodInfo* method)
{
	{
...
extern "C" void TlsServerCertificateRequest_ProcessAsTls1_m4769 (TlsServerCertificateRequest_t915 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	ASN1_t802 * V_4 = {0};
	{
		uint8_t L_0 = TlsStream_ReadByte_m4704(__this, /*hidden argument*/NULL);
		V_0 = L_0;
		int32_t L_1 = V_0;
...
IL_001a:
	{
		ClientCertificateTypeU5BU5D_t906* L_2 = (__this->___certificateTypes_9);
		int32_t L_3 = V_1;
		uint8_t L_4 = TlsStream_ReadByte_m4704(__this, /*hidden argument*/NULL);
		NullCheck(L_2);
...
IL_002c:
	...
	{
		int16_t L_8 = TlsStream_ReadInt16_m4705(__this, /*hidden argument*/NULL);
		if (!L_8)
		{
			goto IL_00aa;
		}
	...
	{
		int16_t L_9 = TlsStream_ReadInt16_m4705(__this, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_10 = TlsStream_ReadBytes_m4707(__this, L_9, /*hidden argument*/NULL);
		ASN1_t802 * L_11 = (ASN1_t802 *)il2cpp_codegen_object_new (ASN1_t802_il2cpp_TypeInfo_var);
		ASN1__ctor_m4001(L_11, L_10, /*hidden argument*/NULL);
		V_2 = L_11;
		ASN1_t802 * L_12 = V_2;
		NullCheck(L_12);
		int32_t L_13 = ASN1_get_Count_m4002(L_12, /*hidden argument*/NULL);
...
IL_0068:
	{
		...
		int32_t L_15 = V_3;
		NullCheck(L_14);
		ASN1_t802 * L_16 = ASN1_get_Item_m4013(L_14, L_15, /*hidden argument*/NULL);
		NullCheck(L_16);
		ByteU5BU5D_t772* L_17 = ASN1_get_Value_m4005(L_16, /*hidden argument*/NULL);
		ASN1_t802 * L_18 = (ASN1_t802 *)il2cpp_codegen_object_new (ASN1_t802_il2cpp_TypeInfo_var);
		ASN1__ctor_m4001(L_18, L_17, /*hidden argument*/NULL);
		V_4 = L_18;
		StringU5BU5D_t85* L_19 = (__this->___distinguisedNames_10);
		int32_t L_20 = V_3;
		IL2CPP_RUNTIME_CLASS_INIT(Encoding_t938_il2cpp_TypeInfo_var);
		Encoding_t938 * L_21 = Encoding_get_UTF8_m4849(NULL /*static, unused*/, /*hidden argument*/NULL);
		ASN1_t802 * L_22 = V_4;
		NullCheck(L_22);
		ASN1_t802 * L_23 = ASN1_get_Item_m4013(L_22, 1, /*hidden argument*/NULL);
		NullCheck(L_23);
		ByteU5BU5D_t772* L_24 = ASN1_get_Value_m4005(L_23, /*hidden argument*/NULL);
		NullCheck(L_21);
...
IL_009e:
	{
		...
		ASN1_t802 * L_28 = V_2;
		NullCheck(L_28);
		int32_t L_29 = ASN1_get_Count_m4002(L_28, /*hidden argument*/NULL);
...
extern "C" void TlsServerFinished__ctor_m4770 (TlsServerFinished_t916 * __this, Context_t859 * ___context, ByteU5BU5D_t772* ___buffer, const MethodInfo* method)
{
	{
		Context_t859 * L_0 = ___context;
		ByteU5BU5D_t772* L_1 = ___buffer;
		HandshakeMessage__ctor_m4722(__this, L_0, ((int32_t)20), L_1, /*hidden argument*/NULL);
		return;
	}
}
...
extern "C" void TlsServerFinished__cctor_m4771 (Object_t * __this /* static, unused */, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	}
	{
		...
		RuntimeHelpers_InitializeArray_m622(NULL /*static, unused*/, (Array_t *)(Array_t *)L_0, LoadFieldToken(U3CPrivateImplementationDetailsU3E_t931____U24U24fieldU2D22_14_FieldInfo_var), /*hidden argument*/NULL);
...
extern "C" void TlsServerFinished_Update_m4772 (TlsServerFinished_t916 * __this, const MethodInfo* method)
{
	{
		HandshakeMessage_Update_m4727(__this, /*hidden argument*/NULL);
		Context_t859 * L_0 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_0);
		Context_set_HandshakeState_m4430(L_0, 2, /*hidden argument*/NULL);
		return;
	}
}
...
extern "C" void TlsServerFinished_ProcessAsSsl3_m4773 (TlsServerFinished_t916 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	ByteU5BU5D_t772* V_3 = {0};
	{
		Context_t859 * L_0 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_0);
		ByteU5BU5D_t772* L_1 = Context_get_MasterSecret_m4450(L_0, /*hidden argument*/NULL);
		SslHandshakeHash_t898 * L_2 = (SslHandshakeHash_t898 *)il2cpp_codegen_object_new (SslHandshakeHash_t898_il2cpp_TypeInfo_var);
		SslHandshakeHash__ctor_m4590(L_2, L_1, /*hidden argument*/NULL);
		V_0 = L_2;
		Context_t859 * L_3 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_3);
		TlsStream_t873 * L_4 = Context_get_HandshakeMessages_m4437(L_3, /*hidden argument*/NULL);
		NullCheck(L_4);
		ByteU5BU5D_t772* L_5 = TlsStream_ToArray_m4714(L_4, /*hidden argument*/NULL);
		V_1 = L_5;
		...
		ByteU5BU5D_t772* L_17 = TlsStream_ReadBytes_m4707(__this, (((int32_t)((int32_t)L_16))), /*hidden argument*/NULL);
		V_2 = L_17;
		...
		bool L_22 = HandshakeMessage_Compare_m4729(NULL /*static, unused*/, L_20, L_21, /*hidden argument*/NULL);
		if (L_22)
		{
			goto IL_0086;
		}
	...
	{
		TlsException_t904 * L_23 = (TlsException_t904 *)il2cpp_codegen_object_new (TlsException_t904_il2cpp_TypeInfo_var);
		TlsException__ctor_m4678(L_23, ((int32_t)71), _stringLiteral701, /*hidden argument*/NULL);
		il2cpp_codegen_raise_exception((Il2CppCodeGenException*)L_23);
	}
...
extern Il2CppCodeGenString* _stringLiteral701;
extern "C" void TlsServerFinished_ProcessAsTls1_m4774 (TlsServerFinished_t916 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	ByteU5BU5D_t772* V_4 = {0};
	{
		...
		ByteU5BU5D_t772* L_1 = TlsStream_ReadBytes_m4707(__this, (((int32_t)((int32_t)L_0))), /*hidden argument*/NULL);
		V_0 = L_1;
		MD5SHA1_t853 * L_2 = (MD5SHA1_t853 *)il2cpp_codegen_object_new (MD5SHA1_t853_il2cpp_TypeInfo_var);
		MD5SHA1__ctor_m4308(L_2, /*hidden argument*/NULL);
		V_1 = L_2;
		Context_t859 * L_3 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_3);
		TlsStream_t873 * L_4 = Context_get_HandshakeMessages_m4437(L_3, /*hidden argument*/NULL);
		...
		NullCheck(L_8);
		NullCheck(L_6);
		ByteU5BU5D_t772* L_9 = HashAlgorithm_ComputeHash_m4842(L_6, L_7, 0, (((int32_t)((int32_t)(((Array_t *)L_8)->max_length)))), /*hidden argument*/NULL);
		V_3 = L_9;
		Context_t859 * L_10 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_10);
		SecurityParameters_t872 * L_11 = Context_get_Current_m4468(L_10, /*hidden argument*/NULL);
		NullCheck(L_11);
		CipherSuite_t858 * L_12 = SecurityParameters_get_Cipher_m4539(L_11, /*hidden argument*/NULL);
		Context_t859 * L_13 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_13);
		ByteU5BU5D_t772* L_14 = Context_get_MasterSecret_m4450(L_13, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_15 = V_3;
		NullCheck(L_12);
		ByteU5BU5D_t772* L_16 = CipherSuite_PRF_m4350(L_12, L_14, _stringLiteral702, L_15, ((int32_t)12), /*hidden argument*/NULL);
		V_4 = L_16;
		ByteU5BU5D_t772* L_17 = V_4;
		ByteU5BU5D_t772* L_18 = V_0;
		bool L_19 = HandshakeMessage_Compare_m4729(NULL /*static, unused*/, L_17, L_18, /*hidden argument*/NULL);
		if (L_19)
		{
			goto IL_0073;
		}
	}
	{
		...
		TlsException__ctor_m4673(L_20, _stringLiteral701, /*hidden argument*/NULL);
...
extern "C" void TlsServerHello__ctor_m4775 (TlsServerHello_t917 * __this, Context_t859 * ___context, ByteU5BU5D_t772* ___buffer, const MethodInfo* method)
{
	{
		Context_t859 * L_0 = ___context;
		ByteU5BU5D_t772* L_1 = ___buffer;
		HandshakeMessage__ctor_m4722(__this, L_0, 2, L_1, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerHello::Update()
extern TypeInfo* ByteU5BU5D_t772_il2cpp_TypeInfo_var;
extern "C" void TlsServerHello_Update_m4776 (TlsServerHello_t917 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	ByteU5BU5D_t772* V_4 = {0};
	{
		...
		NullCheck(L_0);
		Context_set_SessionId_m4422(L_0, L_1, /*hidden argument*/NULL);
		Context_t859 * L_2 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_3 = (__this->___random_10);
		NullCheck(L_2);
		Context_set_ServerRandom_m4445(L_2, L_3, /*hidden argument*/NULL);
		Context_t859 * L_4 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_4);
		SecurityParameters_t872 * L_5 = Context_get_Negotiating_m4469(L_4, /*hidden argument*/NULL);
		CipherSuite_t858 * L_6 = (__this->___cipherSuite_12);
		NullCheck(L_5);
		SecurityParameters_set_Cipher_m4540(L_5, L_6, /*hidden argument*/NULL);
		Context_t859 * L_7 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		int32_t L_8 = (__this->___compressionMethod_9);
		NullCheck(L_7);
		Context_set_CompressionMethod_m4424(L_7, L_8, /*hidden argument*/NULL);
		Context_t859 * L_9 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_9);
		Context_set_ProtocolNegotiated_m4416(L_9, 1, /*hidden argument*/NULL);
		Context_t859 * L_10 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_10);
		ByteU5BU5D_t772* L_11 = Context_get_ClientRandom_m4442(L_10, /*hidden argument*/NULL);
		NullCheck(L_11);
		V_0 = (((int32_t)((int32_t)(((Array_t *)L_11)->max_length))));
		Context_t859 * L_12 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_12);
		ByteU5BU5D_t772* L_13 = Context_get_ServerRandom_m4444(L_12, /*hidden argument*/NULL);
		NullCheck(L_13);
		...
		Context_t859 * L_17 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_17);
		ByteU5BU5D_t772* L_18 = Context_get_ClientRandom_m4442(L_17, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_19 = V_3;
		int32_t L_20 = V_0;
		Buffer_BlockCopy_m3905(NULL /*static, unused*/, (Array_t *)(Array_t *)L_18, 0, (Array_t *)(Array_t *)L_19, 0, L_20, /*hidden argument*/NULL);
		Context_t859 * L_21 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_21);
		ByteU5BU5D_t772* L_22 = Context_get_ServerRandom_m4444(L_21, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_23 = V_3;
		int32_t L_24 = V_0;
		int32_t L_25 = V_1;
		Buffer_BlockCopy_m3905(NULL /*static, unused*/, (Array_t *)(Array_t *)L_22, 0, (Array_t *)(Array_t *)L_23, L_24, L_25, /*hidden argument*/NULL);
		Context_t859 * L_26 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_27 = V_3;
		NullCheck(L_26);
		Context_set_RandomCS_m4447(L_26, L_27, /*hidden argument*/NULL);
		int32_t L_28 = V_2;
		V_4 = ((ByteU5BU5D_t772*)SZArrayNew(ByteU5BU5D_t772_il2cpp_TypeInfo_var, L_28));
		Context_t859 * L_29 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_29);
		ByteU5BU5D_t772* L_30 = Context_get_ServerRandom_m4444(L_29, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_31 = V_4;
		int32_t L_32 = V_1;
		Buffer_BlockCopy_m3905(NULL /*static, unused*/, (Array_t *)(Array_t *)L_30, 0, (Array_t *)(Array_t *)L_31, 0, L_32, /*hidden argument*/NULL);
		Context_t859 * L_33 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_33);
		ByteU5BU5D_t772* L_34 = Context_get_ClientRandom_m4442(L_33, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_35 = V_4;
		int32_t L_36 = V_1;
		int32_t L_37 = V_0;
		Buffer_BlockCopy_m3905(NULL /*static, unused*/, (Array_t *)(Array_t *)L_34, 0, (Array_t *)(Array_t *)L_35, L_36, L_37, /*hidden argument*/NULL);
		Context_t859 * L_38 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_39 = V_4;
		NullCheck(L_38);
		Context_set_RandomSC_m4449(L_38, L_39, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerHello::ProcessAsSsl3()
extern "C" void TlsServerHello_ProcessAsSsl3_m4777 (TlsServerHello_t917 * __this, const MethodInfo* method)
{
	{
...
extern "C" void TlsServerHello_ProcessAsTls1_m4778 (TlsServerHello_t917 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	int16_t V_1 = 0;
	{
		int16_t L_0 = TlsStream_ReadInt16_m4705(__this, /*hidden argument*/NULL);
		TlsServerHello_processProtocol_m4779(__this, L_0, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_1 = TlsStream_ReadBytes_m4707(__this, ((int32_t)32), /*hidden argument*/NULL);
		__this->___random_10 = L_1;
		uint8_t L_2 = TlsStream_ReadByte_m4704(__this, /*hidden argument*/NULL);
		V_0 = L_2;
		int32_t L_3 = V_0;
	...
	{
		int32_t L_4 = V_0;
		ByteU5BU5D_t772* L_5 = TlsStream_ReadBytes_m4707(__this, L_4, /*hidden argument*/NULL);
		__this->___sessionId_11 = L_5;
		Context_t859 * L_6 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_6);
		TlsClientSettings_t871 * L_7 = Context_get_ClientSettings_m4426(L_6, /*hidden argument*/NULL);
		NullCheck(L_7);
		String_t* L_8 = TlsClientSettings_get_TargetHost_m4666(L_7, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_9 = (__this->___sessionId_11);
		IL2CPP_RUNTIME_CLASS_INIT(ClientSessionCache_t867_il2cpp_TypeInfo_var);
		ClientSessionCache_Add_m4407(NULL /*static, unused*/, L_8, L_9, /*hidden argument*/NULL);
		Context_t859 * L_10 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_11 = (__this->___sessionId_11);
		Context_t859 * L_12 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_12);
		ByteU5BU5D_t772* L_13 = Context_get_SessionId_m4421(L_12, /*hidden argument*/NULL);
		bool L_14 = HandshakeMessage_Compare_m4729(NULL /*static, unused*/, L_11, L_13, /*hidden argument*/NULL);
		NullCheck(L_10);
		Context_set_AbbreviatedHandshake_m4414(L_10, L_14, /*hidden argument*/NULL);
		goto IL_0082;
	}

IL_0076:
	{
		Context_t859 * L_15 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_15);
		Context_set_AbbreviatedHandshake_m4414(L_15, 0, /*hidden argument*/NULL);
	}

IL_0082:
	{
		int16_t L_16 = TlsStream_ReadInt16_m4705(__this, /*hidden argument*/NULL);
		V_1 = L_16;
		Context_t859 * L_17 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_17);
		CipherSuiteCollection_t860 * L_18 = Context_get_SupportedCiphers_m4435(L_17, /*hidden argument*/NULL);
		int16_t L_19 = V_1;
		NullCheck(L_18);
		int32_t L_20 = CipherSuiteCollection_IndexOf_m4376(L_18, L_19, /*hidden argument*/NULL);
	...
	}
	{
		...
		TlsException__ctor_m4678(L_21, ((int32_t)71), _stringLiteral703, /*hidden argument*/NULL);
		il2cpp_codegen_raise_exception((Il2CppCodeGenException*)L_21);
	}

IL_00ad:
	{
		Context_t859 * L_22 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_22);
		CipherSuiteCollection_t860 * L_23 = Context_get_SupportedCiphers_m4435(L_22, /*hidden argument*/NULL);
		int16_t L_24 = V_1;
		NullCheck(L_23);
		CipherSuite_t858 * L_25 = CipherSuiteCollection_get_Item_m4369(L_23, L_24, /*hidden argument*/NULL);
		__this->___cipherSuite_12 = L_25;
		uint8_t L_26 = TlsStream_ReadByte_m4704(__this, /*hidden argument*/NULL);
...
extern "C" void TlsServerHello_processProtocol_m4779 (TlsServerHello_t917 * __this, int16_t ___protocol, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	int32_t V_0 = {0};
	{
		...
		NullCheck(L_0);
		int32_t L_2 = Context_DecodeProtocolCode_m4466(L_0, L_1, /*hidden argument*/NULL);
		V_0 = L_2;
		int32_t L_3 = V_0;
		Context_t859 * L_4 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_4);
		int32_t L_5 = Context_get_SecurityProtocolFlags_m4419(L_4, /*hidden argument*/NULL);
		int32_t L_6 = V_0;
	...
	}
	{
		Context_t859 * L_7 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_7);
		int32_t L_8 = Context_get_SecurityProtocolFlags_m4419(L_7, /*hidden argument*/NULL);
...
IL_003b:
	{
		...
		int32_t L_10 = V_0;
		NullCheck(L_9);
		Context_set_SecurityProtocol_m4418(L_9, L_10, /*hidden argument*/NULL);
		Context_t859 * L_11 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_11);
		CipherSuiteCollection_t860 * L_12 = Context_get_SupportedCiphers_m4435(L_11, /*hidden argument*/NULL);
		NullCheck(L_12);
		CipherSuiteCollection_Clear_m4374(L_12, /*hidden argument*/NULL);
		Context_t859 * L_13 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_13);
		Context_set_SupportedCiphers_m4436(L_13, (CipherSuiteCollection_t860 *)NULL, /*hidden argument*/NULL);
		Context_t859 * L_14 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		int32_t L_15 = V_0;
		CipherSuiteCollection_t860 * L_16 = CipherSuiteFactory_GetSupportedCiphers_m4381(NULL /*static, unused*/, L_15, /*hidden argument*/NULL);
		NullCheck(L_14);
		Context_set_SupportedCiphers_m4436(L_14, L_16, /*hidden argument*/NULL);
		goto IL_0086;
	}
...
IL_0079:
	{
		...
		TlsException__ctor_m4678(L_17, ((int32_t)70), _stringLiteral644, /*hidden argument*/NULL);
...
extern "C" void TlsServerHelloDone__ctor_m4780 (TlsServerHelloDone_t918 * __this, Context_t859 * ___context, ByteU5BU5D_t772* ___buffer, const MethodInfo* method)
{
	{
		Context_t859 * L_0 = ___context;
		ByteU5BU5D_t772* L_1 = ___buffer;
		HandshakeMessage__ctor_m4722(__this, L_0, ((int32_t)14), L_1, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerHelloDone::ProcessAsSsl3()
extern "C" void TlsServerHelloDone_ProcessAsSsl3_m4781 (TlsServerHelloDone_t918 * __this, const MethodInfo* method)
{
	{
		return;
	}
...
extern "C" void TlsServerHelloDone_ProcessAsTls1_m4782 (TlsServerHelloDone_t918 * __this, const MethodInfo* method)
{
	{
		return;
	}
...
extern "C" void TlsServerKeyExchange__ctor_m4783 (TlsServerKeyExchange_t919 * __this, Context_t859 * ___context, ByteU5BU5D_t772* ___buffer, const MethodInfo* method)
{
	{
		Context_t859 * L_0 = ___context;
		ByteU5BU5D_t772* L_1 = ___buffer;
		HandshakeMessage__ctor_m4722(__this, L_0, ((int32_t)12), L_1, /*hidden argument*/NULL);
		TlsServerKeyExchange_verifySignature_m4787(__this, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerKeyExchange::Update()
extern "C" void TlsServerKeyExchange_Update_m4784 (TlsServerKeyExchange_t919 * __this, const MethodInfo* method)
{
	{
		HandshakeMessage_Update_m4727(__this, /*hidden argument*/NULL);
		Context_t859 * L_0 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		...
		TlsServerSettings_t870 * L_1 = Context_get_ServerSettings_m4425(L_0, /*hidden argument*/NULL);
		NullCheck(L_1);
		TlsServerSettings_set_ServerKeyExchange_m4682(L_1, 1, /*hidden argument*/NULL);
		Context_t859 * L_2 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_2);
		TlsServerSettings_t870 * L_3 = Context_get_ServerSettings_m4425(L_2, /*hidden argument*/NULL);
		RSAParameters_t905  L_4 = (__this->___rsaParams_9);
		NullCheck(L_3);
		TlsServerSettings_set_RsaParameters_m4687(L_3, L_4, /*hidden argument*/NULL);
		Context_t859 * L_5 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_5);
		TlsServerSettings_t870 * L_6 = Context_get_ServerSettings_m4425(L_5, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_7 = (__this->___signedParams_10);
		NullCheck(L_6);
		TlsServerSettings_set_SignedParams_m4688(L_6, L_7, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Mono.Security.Protocol.Tls.Handshake.Client.TlsServerKeyExchange::ProcessAsSsl3()
extern "C" void TlsServerKeyExchange_ProcessAsSsl3_m4785 (TlsServerKeyExchange_t919 * __this, const MethodInfo* method)
{
	{
...
extern "C" void TlsServerKeyExchange_ProcessAsTls1_m4786 (TlsServerKeyExchange_t919 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	RSAParameters_t905  V_0 = {0};
	{
		...
		int16_t L_2 = TlsStream_ReadInt16_m4705(__this, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_3 = TlsStream_ReadBytes_m4707(__this, L_2, /*hidden argument*/NULL);
		L_1->___Modulus_6 = L_3;
		RSAParameters_t905 * L_4 = &(__this->___rsaParams_9);
		int16_t L_5 = TlsStream_ReadInt16_m4705(__this, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_6 = TlsStream_ReadBytes_m4707(__this, L_5, /*hidden argument*/NULL);
		L_4->___Exponent_7 = L_6;
		int16_t L_7 = TlsStream_ReadInt16_m4705(__this, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_8 = TlsStream_ReadBytes_m4707(__this, L_7, /*hidden argument*/NULL);
...
extern "C" void TlsServerKeyExchange_verifySignature_m4787 (TlsServerKeyExchange_t919 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	bool V_3 = false;
	{
		...
		MD5SHA1__ctor_m4308(L_0, /*hidden argument*/NULL);
		V_0 = L_0;
		RSAParameters_t905 * L_1 = &(__this->___rsaParams_9);
		...
		TlsStream__ctor_m4694(L_5, /*hidden argument*/NULL);
		V_2 = L_5;
		TlsStream_t873 * L_6 = V_2;
		Context_t859 * L_7 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_7);
		ByteU5BU5D_t772* L_8 = Context_get_RandomCS_m4446(L_7, /*hidden argument*/NULL);
		NullCheck(L_6);
		TlsStream_Write_m4712(L_6, L_8, /*hidden argument*/NULL);
		TlsStream_t873 * L_9 = V_2;
		ByteU5BU5D_t772* L_10 = TlsStream_ToArray_m4714(__this, /*hidden argument*/NULL);
		int32_t L_11 = V_1;
		NullCheck(L_9);
		...
		NullCheck(L_13);
		ByteU5BU5D_t772* L_14 = TlsStream_ToArray_m4714(L_13, /*hidden argument*/NULL);
		NullCheck(L_12);
		HashAlgorithm_ComputeHash_m4868(L_12, L_14, /*hidden argument*/NULL);
		TlsStream_t873 * L_15 = V_2;
		NullCheck(L_15);
		TlsStream_Reset_m4713(L_15, /*hidden argument*/NULL);
		MD5SHA1_t853 * L_16 = V_0;
		Context_t859 * L_17 = HandshakeMessage_get_Context_m4723(__this, /*hidden argument*/NULL);
		NullCheck(L_17);
		TlsServerSettings_t870 * L_18 = Context_get_ServerSettings_m4425(L_17, /*hidden argument*/NULL);
		NullCheck(L_18);
		RSA_t823 * L_19 = TlsServerSettings_get_CertificateRSA_m4685(L_18, /*hidden argument*/NULL);
		ByteU5BU5D_t772* L_20 = (__this->___signedParams_10);
		NullCheck(L_16);
		bool L_21 = MD5SHA1_VerifySignature_m4313(L_16, L_19, L_20, /*hidden argument*/NULL);
		V_3 = L_21;
		bool L_22 = V_3;
		if (L_22)
		{
	...
	{
		TlsException_t904 * L_23 = (TlsException_t904 *)il2cpp_codegen_object_new (TlsException_t904_il2cpp_TypeInfo_var);
		TlsException__ctor_m4678(L_23, ((int32_t)50), _stringLiteral704, /*hidden argument*/NULL);
		il2cpp_codegen_raise_exception((Il2CppCodeGenException*)L_23);
	}
...
extern "C" void PrimalityTest__ctor_m4788 (PrimalityTest_t920 * __this, Object_t * ___object, IntPtr_t ___method, const MethodInfo* method)
{
...
extern "C" bool PrimalityTest_Invoke_m4789 (PrimalityTest_t920 * __this, BigInteger_t796 * ___bi, int32_t ___confidence, const MethodInfo* method)
{
	if(__this->___prev_9 != NULL)
	{
		PrimalityTest_Invoke_m4789((PrimalityTest_t920 *)__this->___prev_9,___bi, ___confidence, method);
	}
...
extern "C" Object_t * PrimalityTest_BeginInvoke_m4790 (PrimalityTest_t920 * __this, BigInteger_t796 * ___bi, int32_t ___confidence, AsyncCallback_t266 * ___callback, Object_t * ___object, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
...
extern "C" bool PrimalityTest_EndInvoke_m4791 (PrimalityTest_t920 * __this, Object_t * ___result, const MethodInfo* method)
{
	Il2CppObject *__result = il2cpp_delegate_end_invoke((Il2CppAsyncResult*) ___result, 0);
	return *(bool*)UnBox ((Il2CppCodeGenObject*)__result);
}
// System.Void Mono.Security.Protocol.Tls.CertificateValidationCallback::.ctor(System.Object,System.IntPtr)
extern "C" void CertificateValidationCallback__ctor_m4792 (CertificateValidationCallback_t895 * __this, Object_t * ___object, IntPtr_t ___method, const MethodInfo* method)
{
	__this->___method_ptr_0 = (methodPointerType)((MethodInfo*)___method.___m_value_0)->method;
	__this->___method_3 = ___method;
	__this->___m_target_2 = ___object;
...
extern "C" bool CertificateValidationCallback_Invoke_m4793 (CertificateValidationCallback_t895 * __this, X509Certificate_t903 * ___certificate, Int32U5BU5D_t46* ___certificateErrors, const MethodInfo* method)
{
	if(__this->___prev_9 != NULL)
	{
		CertificateValidationCallback_Invoke_m4793((CertificateValidationCallback_t895 *)__this->___prev_9,___certificate, ___certificateErrors, method);
	}
	il2cpp_codegen_raise_execution_engine_exception_if_method_is_not_found((MethodInfo*)(__this->___method_3.___m_value_0));
	bool ___methodIsStatic = MethodIsStatic((MethodInfo*)(__this->___method_3.___m_value_0));
	if (__this->___m_target_2 != NULL && ___methodIsStatic)
...
extern "C" Object_t * CertificateValidationCallback_BeginInvoke_m4794 (CertificateValidationCallback_t895 * __this, X509Certificate_t903 * ___certificate, Int32U5BU5D_t46* ___certificateErrors, AsyncCallback_t266 * ___callback, Object_t * ___object, const MethodInfo* method)
{
	void *__d_args[3] = {0};
...
extern "C" bool CertificateValidationCallback_EndInvoke_m4795 (CertificateValidationCallback_t895 * __this, Object_t * ___result, const MethodInfo* method)
{
	Il2CppObject *__result = il2cpp_delegate_end_invoke((Il2CppAsyncResult*) ___result, 0);
	return *(bool*)UnBox ((Il2CppCodeGenObject*)__result);
}
// System.Void Mono.Security.Protocol.Tls.CertificateValidationCallback2::.ctor(System.Object,System.IntPtr)
extern "C" void CertificateValidationCallback2__ctor_m4796 (CertificateValidationCallback2_t896 * __this, Object_t * ___object, IntPtr_t ___method, const MethodInfo* method)
{
	__this->___method_ptr_0 = (methodPointerType)((MethodInfo*)___method.___m_value_0)->method;
	__this->___method_3 = ___method;
	__this->___m_target_2 = ___object;
...
extern "C" ValidationResult_t893 * CertificateValidationCallback2_Invoke_m4797 (CertificateValidationCallback2_t896 * __this, X509CertificateCollection_t827 * ___collection, const MethodInfo* method)
{
	if(__this->___prev_9 != NULL)
	{
		CertificateValidationCallback2_Invoke_m4797((CertificateValidationCallback2_t896 *)__this->___prev_9,___collection, method);
	}
	il2cpp_codegen_raise_execution_engine_exception_if_method_is_not_found((MethodInfo*)(__this->___method_3.___m_value_0));
	bool ___methodIsStatic = MethodIsStatic((MethodInfo*)(__this->___method_3.___m_value_0));
	if (__this->___m_target_2 != NULL && ___methodIsStatic)
...
extern "C" Object_t * CertificateValidationCallback2_BeginInvoke_m4798 (CertificateValidationCallback2_t896 * __this, X509CertificateCollection_t827 * ___collection, AsyncCallback_t266 * ___callback, Object_t * ___object, const MethodInfo* method)
{
	void *__d_args[2] = {0};
...
extern "C" ValidationResult_t893 * CertificateValidationCallback2_EndInvoke_m4799 (CertificateValidationCallback2_t896 * __this, Object_t * ___result, const MethodInfo* method)
{
	Il2CppObject *__result = il2cpp_delegate_end_invoke((Il2CppAsyncResult*) ___result, 0);
	return (ValidationResult_t893 *)__result;
}
// System.Void Mono.Security.Protocol.Tls.CertificateSelectionCallback::.ctor(System.Object,System.IntPtr)
extern "C" void CertificateSelectionCallback__ctor_m4800 (CertificateSelectionCallback_t879 * __this, Object_t * ___object, IntPtr_t ___method, const MethodInfo* method)
{
	__this->___method_ptr_0 = (methodPointerType)((MethodInfo*)___method.___m_value_0)->method;
	__this->___method_3 = ___method;
	__this->___m_target_2 = ___object;
...
extern "C" X509Certificate_t903 * CertificateSelectionCallback_Invoke_m4801 (CertificateSelectionCallback_t879 * __this, X509CertificateCollection_t902 * ___clientCertificates, X509Certificate_t903 * ___serverCertificate, String_t* ___targetHost, X509CertificateCollection_t902 * ___serverRequestedCertificates, const MethodInfo* method)
{
	if(__this->___prev_9 != NULL)
	{
		CertificateSelectionCallback_Invoke_m4801((CertificateSelectionCallback_t879 *)__this->___prev_9,___clientCertificates, ___serverCertificate, ___targetHost, ___serverRequestedCertificates, method);
	}
	il2cpp_codegen_raise_execution_engine_exception_if_method_is_not_found((MethodInfo*)(__this->___method_3.___m_value_0));
	bool ___methodIsStatic = MethodIsStatic((MethodInfo*)(__this->___method_3.___m_value_0));
	if (__this->___m_target_2 != NULL && ___methodIsStatic)
...
extern "C" X509Certificate_t903 * CertificateSelectionCallback_EndInvoke_m4803 (CertificateSelectionCallback_t879 * __this, Object_t * ___result, const MethodInfo* method)
{
	Il2CppObject *__result = il2cpp_delegate_end_invoke((Il2CppAsyncResult*) ___result, 0);
	return (X509Certificate_t903 *)__result;
}
// System.Void Mono.Security.Protocol.Tls.PrivateKeySelectionCallback::.ctor(System.Object,System.IntPtr)
extern "C" void PrivateKeySelectionCallback__ctor_m4804 (PrivateKeySelectionCallback_t880 * __this, Object_t * ___object, IntPtr_t ___method, const MethodInfo* method)
{
	__this->___method_ptr_0 = (methodPointerType)((MethodInfo*)___method.___m_value_0)->method;
	__this->___method_3 = ___method;
	__this->___m_target_2 = ___object;
...
extern "C" AsymmetricAlgorithm_t921 * PrivateKeySelectionCallback_Invoke_m4805 (PrivateKeySelectionCallback_t880 * __this, X509Certificate_t903 * ___certificate, String_t* ___targetHost, const MethodInfo* method)
{
	if(__this->___prev_9 != NULL)
	{
		PrivateKeySelectionCallback_Invoke_m4805((PrivateKeySelectionCallback_t880 *)__this->___prev_9,___certificate, ___targetHost, method);
	}
	il2cpp_codegen_raise_execution_engine_exception_if_method_is_not_found((MethodInfo*)(__this->___method_3.___m_value_0));
	bool ___methodIsStatic = MethodIsStatic((MethodInfo*)(__this->___method_3.___m_value_0));
	if (__this->___m_target_2 != NULL && ___methodIsStatic)
...
extern "C" Object_t * PrivateKeySelectionCallback_BeginInvoke_m4806 (PrivateKeySelectionCallback_t880 * __this, X509Certificate_t903 * ___certificate, String_t* ___targetHost, AsyncCallback_t266 * ___callback, Object_t * ___object, const MethodInfo* method)
{
	void *__d_args[3] = {0};
	__d_args[0] = ___certificate;
...
extern "C" AsymmetricAlgorithm_t921 * PrivateKeySelectionCallback_EndInvoke_m4807 (PrivateKeySelectionCallback_t880 * __this, Object_t * ___result, const MethodInfo* method)
{
	Il2CppObject *__result = il2cpp_delegate_end_invoke((Il2CppAsyncResult*) ___result, 0);
