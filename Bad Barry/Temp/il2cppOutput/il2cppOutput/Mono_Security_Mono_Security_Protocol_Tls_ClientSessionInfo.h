...
struct  ClientSessionInfo_t896  : public Object_t
{
	...
	ByteU5BU5D_t802* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t802* ___masterSecret_5;
};
struct ClientSessionInfo_t896_StaticFields{
