...
struct  ClientSessionInfo_t916  : public Object_t
{
	...
	ByteU5BU5D_t822* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t822* ___masterSecret_5;
};
struct ClientSessionInfo_t916_StaticFields{
