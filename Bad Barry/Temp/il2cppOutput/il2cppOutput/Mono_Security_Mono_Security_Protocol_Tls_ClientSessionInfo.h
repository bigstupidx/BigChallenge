...
struct  ClientSessionInfo_t853  : public Object_t
{
	...
	ByteU5BU5D_t759* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t759* ___masterSecret_5;
};
struct ClientSessionInfo_t853_StaticFields{
