...
struct  ClientSessionInfo_t911  : public Object_t
{
	...
	ByteU5BU5D_t817* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t817* ___masterSecret_5;
};
struct ClientSessionInfo_t911_StaticFields{
