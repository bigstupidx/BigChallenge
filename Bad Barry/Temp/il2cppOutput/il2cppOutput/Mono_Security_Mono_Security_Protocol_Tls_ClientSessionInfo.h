...
struct  ClientSessionInfo_t834  : public Object_t
{
	...
	ByteU5BU5D_t740* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t740* ___masterSecret_5;
};
struct ClientSessionInfo_t834_StaticFields{
