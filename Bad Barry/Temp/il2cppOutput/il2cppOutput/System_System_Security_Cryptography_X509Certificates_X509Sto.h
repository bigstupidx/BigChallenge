...
struct  X509Store_t912  : public Object_t
{
	...
	X509Certificate2Collection_t906 * ___list_2;
	...
	X509Store_t711 * ___store_4;
};
struct X509Store_t912_StaticFields{
	...
	Dictionary_2_t219 * ___U3CU3Ef__switchU24mapF_5;
};
