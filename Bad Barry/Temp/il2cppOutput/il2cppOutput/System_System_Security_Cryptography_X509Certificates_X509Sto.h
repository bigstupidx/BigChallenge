...
struct  X509Store_t1023  : public Object_t
{
	...
	X509Certificate2Collection_t1017 * ___list_2;
	...
	X509Store_t826 * ___store_4;
};
struct X509Store_t1023_StaticFields{
	...
	Dictionary_2_t262 * ___U3CU3Ef__switchU24mapF_5;
};
