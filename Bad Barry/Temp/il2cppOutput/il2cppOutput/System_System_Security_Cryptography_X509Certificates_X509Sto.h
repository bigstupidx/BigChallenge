...
struct  X509Store_t1065  : public Object_t
{
	...
	X509Certificate2Collection_t1059 * ___list_2;
	...
	X509Store_t869 * ___store_4;
};
struct X509Store_t1065_StaticFields{
	...
	Dictionary_2_t308 * ___U3CU3Ef__switchU24mapF_5;
};
