...
struct  X509Store_t1035  : public Object_t
{
	...
	X509Certificate2Collection_t1029 * ___list_2;
	...
	X509Store_t839 * ___store_4;
};
struct X509Store_t1035_StaticFields{
	...
	Dictionary_2_t276 * ___U3CU3Ef__switchU24mapF_5;
};
