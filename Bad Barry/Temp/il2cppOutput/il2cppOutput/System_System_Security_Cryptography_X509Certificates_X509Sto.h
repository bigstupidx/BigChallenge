...
struct  X509Store_t1080  : public Object_t
{
	...
	X509Certificate2Collection_t1074 * ___list_2;
	...
	X509Store_t884 * ___store_4;
};
struct X509Store_t1080_StaticFields{
	...
	Dictionary_2_t324 * ___U3CU3Ef__switchU24mapF_5;
};
