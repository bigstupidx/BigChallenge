...
struct  CrossPlatformInputManager_t6  : public Object_t
{
};
struct CrossPlatformInputManager_t6_StaticFields{
	...
	VirtualInput_t7 * ___activeInput_0;
	...
	VirtualInput_t7 * ___s_TouchInput_1;
	...
	VirtualInput_t7 * ___s_HardwareInput_2;
};
