...
struct  CrossPlatformInputManager_t21  : public Object_t
{
};
struct CrossPlatformInputManager_t21_StaticFields{
	...
	VirtualInput_t22 * ___activeInput_0;
	...
	VirtualInput_t22 * ___s_TouchInput_1;
	...
	VirtualInput_t22 * ___s_HardwareInput_2;
};
