...
struct  CrossPlatformInputManager_t29  : public Object_t
{
};
struct CrossPlatformInputManager_t29_StaticFields{
	...
	VirtualInput_t30 * ___activeInput_0;
	...
	VirtualInput_t30 * ___s_TouchInput_1;
	...
	VirtualInput_t30 * ___s_HardwareInput_2;
};
