...
struct  ExtendedKeyUsageExtension_t716  : public X509Extension_t710
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t675 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t716_StaticFields{
	...
	Dictionary_2_t219 * ___U3CU3Ef__switchU24map14_4;
};
