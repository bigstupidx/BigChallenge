...
struct  ExtendedKeyUsageExtension_t871  : public X509Extension_t865
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t830 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t871_StaticFields{
	...
	Dictionary_2_t308 * ___U3CU3Ef__switchU24map14_4;
};
