...
struct  ExtendedKeyUsageExtension_t889  : public X509Extension_t883
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t848 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t889_StaticFields{
	...
	Dictionary_2_t324 * ___U3CU3Ef__switchU24map14_4;
};
