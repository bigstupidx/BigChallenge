...
struct  ExtendedKeyUsageExtension_t844  : public X509Extension_t838
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t803 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t844_StaticFields{
	...
	Dictionary_2_t276 * ___U3CU3Ef__switchU24map14_4;
};
