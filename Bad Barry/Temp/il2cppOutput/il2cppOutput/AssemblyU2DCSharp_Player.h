...
// Player
struct  Player_t80  : public MonoBehaviour_t2
{
	...
	HUDGame_t55 * ___hudGame_20;
	// UnityEngine.GameObject Player::HUD
	GameObject_t40 * ___HUD_21;
	...
	GameObject_t40 * ___knifeRange_26;
};
