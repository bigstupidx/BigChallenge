...
struct  JsonWriter_t728  : public Object_t
{
	...
	TextWriter_t748 * ___writer_10;
};
struct JsonWriter_t728_StaticFields{
	// System.Globalization.NumberFormatInfo LitJson.JsonWriter::number_format
	NumberFormatInfo_t749 * ___number_format_0;
};
