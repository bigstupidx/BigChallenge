...
struct  JsonWriter_t701  : public Object_t
{
	...
	StringBuilder_t393 * ___inst_string_builder_7;
	...
	TextWriter_t721 * ___writer_10;
};
struct JsonWriter_t701_StaticFields{
	// System.Globalization.NumberFormatInfo LitJson.JsonWriter::number_format
	NumberFormatInfo_t722 * ___number_format_0;
};
