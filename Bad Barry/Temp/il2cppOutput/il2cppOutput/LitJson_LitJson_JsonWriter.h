...
struct  JsonWriter_t751  : public Object_t
{
	...
	StringBuilder_t443 * ___inst_string_builder_7;
	...
	TextWriter_t771 * ___writer_10;
};
struct JsonWriter_t751_StaticFields{
	// System.Globalization.NumberFormatInfo LitJson.JsonWriter::number_format
	NumberFormatInfo_t772 * ___number_format_0;
};
