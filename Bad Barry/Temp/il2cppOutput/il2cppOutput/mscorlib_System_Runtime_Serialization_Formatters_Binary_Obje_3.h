...
struct  ObjectWriter_t1592  : public Object_t
{
	...
	Queue_t1261 * ____pendingObjects_2;
	...
	SerializationObjectManager_t1594 * ____manager_13;
};
struct ObjectWriter_t1592_StaticFields{
