...
struct  Joystick_t19  : public MonoBehaviour_t2
{
	...
	VirtualAxis_t14 * ___m_HorizontalVirtualAxis_9;
	...
	VirtualAxis_t14 * ___m_VerticalVirtualAxis_10;
};
