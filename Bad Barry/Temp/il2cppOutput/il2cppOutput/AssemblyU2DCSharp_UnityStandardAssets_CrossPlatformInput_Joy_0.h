...
struct  Joystick_t24  : public MonoBehaviour_t2
{
	...
	VirtualAxis_t19 * ___m_HorizontalVirtualAxis_9;
	...
	VirtualAxis_t19 * ___m_VerticalVirtualAxis_10;
};
