...
struct  Joystick_t32  : public MonoBehaviour_t2
{
	...
	VirtualAxis_t27 * ___m_HorizontalVirtualAxis_9;
	...
	VirtualAxis_t27 * ___m_VerticalVirtualAxis_10;
};
