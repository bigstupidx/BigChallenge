...
struct  U3CPlayAudioU3Ec__Iterator2_t59  : public Object_t
{
	// UnityEngine.AudioSource GameBehavior/<PlayAudio>c__Iterator2::currentAudio
	AudioSource_t16 * ___currentAudio_0;
