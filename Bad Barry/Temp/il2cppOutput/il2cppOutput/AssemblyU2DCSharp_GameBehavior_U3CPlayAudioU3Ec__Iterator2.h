...
struct  U3CPlayAudioU3Ec__Iterator2_t66  : public Object_t
{
	// UnityEngine.AudioSource GameBehavior/<PlayAudio>c__Iterator2::currentAudio
	AudioSource_t24 * ___currentAudio_0;
