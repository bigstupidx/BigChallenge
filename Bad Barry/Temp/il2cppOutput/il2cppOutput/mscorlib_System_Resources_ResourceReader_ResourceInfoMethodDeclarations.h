...
extern "C" void ResourceInfo__ctor_m8581 (ResourceInfo_t1383 * __this, String_t* ___resourceName, int64_t ___valuePosition, int32_t ___type_index, const MethodInfo* method) IL2CPP_METHOD_ATTR;
